...
### `artifacts/catchup-landing` (`@workspace/catchup-landing`)
...
- All CTAs link to `https://www.catchup.page`
- AI chatbot disclaimer ("not medical advice") always included
- No fake stats/ratings — only real factual feature descriptions
